...
const translations = {
  "Portfolio of Ella Graf | Navigating the intersection of technology and design":
    {
      EN: "Portfolio of Ella Graf | Navigating the intersection of technology and design",
      DE: "Portfolio von Ella Graf | Navigation an der Schnittstelle von Technologie und Design",
    },
  "Hello, my name is": {
    EN: "Hello, my name is",
